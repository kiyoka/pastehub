...
#   3. install realtimedbsync-x.x.x.gem to clean environment and test
#   4. rake release
#   5. gem push pkg/realtimedbsync-x.x.x.gem   ( need gem version 1.3.6 or higer. Please "gem update --system" to update )
